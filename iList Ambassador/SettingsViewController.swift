...
class SettingsViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource, MFMailComposeViewControllerDelegate, UIActionSheetDelegate, UINavigationControllerDelegate, ProfilePictureImageViewDelegate, FBSDKSharingDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationController?.navigationBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor: Color.ilistBackgroundColor()]
    ...
    func sharer(_ sharer: FBSDKSharing!, didFailWithError error: Error!) {
        let alertController = UIAlertController(title: NSLocalizedString("ERROR", comment: ""), message: NSLocalizedString("NOT_AVAILABLE", comment: ""), preferredStyle: UIAlertController.Style.alert)
        present(alertController, animated: true, completion: nil)
    }
