...
class PromoVideoView: UIView {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        do {
            try AVAudioSession.sharedInstance().setCategory(AVAudioSessionCategoryPlayback)//sharedInstance().setCategory(.playback, mode: .default)
...
//        AVAudioSession.sharedInstance().setCategory(AVAudioSessionCategoryPlayback, error: nil)
    ...
    private func registerObservers() {
        ...
        observers.append(
            center.addObserver(forName: NSNotification.Name.UIApplicationDidBecomeActive, object: nil, queue: main, using: {
                [weak self] (note) in
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(interruption), name: NSNotification.Name.AVAudioSessionInterruption, object: nil)
    }
